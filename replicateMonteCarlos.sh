...
python CMLE_MonteCarlo_meq.py  > /dev/null 2>> MonteCarloLog.txt #supress ipopt output
python CMLE_MonteCarlo_unique.py  > /dev/null 2>> MonteCarloLog.txt #supress ipopt output
